...
{
    public class TextHud : IFezapFeature
    {
        private List<(FezapVariable var, Func<string> provider)> hudVars = [];

        private FezapVariable hud_hide;
        ...
        public void Initialize()
        {
            ...
            {
                hudVars.Add((new FezapVariable(name, $"If set, enables {desc} text hud.", "0")
                {
                    SaveOnChange = true,
                    Min = 0,
                    Max = 1
            ...
            hud_hide = new FezapVariable("hud_hide", "If set, hides FEZAP HUD entirely when console is not opened.", "0")
            {
                SaveOnChange = true,
                Min = 0,
                Max = 1
        ...
        public void DrawHUD(GameTime gameTime)
        {
            ...
            {
                var console = Fezap.GetFeature<FezapConsole>();
