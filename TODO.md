...
- Bugs
  - [ ] Re-implement gravity and reload traps
    - [ ] While gravity trapped, opening a door will make the door unable to open until you leave the room
  - [x] Custom locked doors look broken
  - [x] When door is unlocked, have to leave and re-enter after first entering
  - [x] Fix "Memory stream is not expandable" caused whenever saving after playing for a while
