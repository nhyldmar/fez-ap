...
{
    internal class VolumeDraw : IFezapFeature
    {
        ...
        class VolumesDrawToggleCommand : IFezapCommand
        {
            ...
            public bool Execute(string[] args)
            {
                ...
                FezapConsole.Print($"Volume wireframes have been {(WireframesEnabled ? "enabled" + (xray ? " in xray mode" : "") : "disabled")}.");
                return true;
            }
        }
    }
