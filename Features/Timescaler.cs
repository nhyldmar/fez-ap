...
{
    internal class Timescaler : IFezapCommand, IFezapFeature
    {
        ...
        public bool Execute(string[] args)
        {
            ...
            {
                FezapConsole.Print($"Incorrect timescale: '{args[0]}'", FezapConsole.OutputType.Warning);
                return false;
            }

            Timescale = timescale;

            FezapConsole.Print($"Timescale has been set to {Timescale.ToString("0.000", CultureInfo.InvariantCulture)}");
