...
{
    internal class LevelTimer : IFezapCommand, IFezapFeature
    {
        ...
        public bool Execute(string[] args)
        {
            ...
            {
                FezapConsole.Print("Cleared current timer.");
                enabled = false;
                active = false;
                timeHistory.Clear();
                return false;
            ...
            {
                FezapConsole.Print("Invalid number of arguments.", FezapConsole.OutputType.Error);
                return false;
            }
            else
            {
                ...
                startLevel = args[0];
                endLevel = args[1];
                FezapConsole.Print("Timer enabled.");
                return true;
            }
        }
