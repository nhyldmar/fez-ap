...
{
    internal class FezapVariable
    {
        public const string VariablesFileName = "FezapVars";

        public static List<FezapVariable> DefinedList { get; private set; } = new List<FezapVariable>();
        ...
        public FezapVariable(string name, string helpText, string defaultValue = "0")
        {
            Name = name;
            HelpText = helpText;
        ...
        static FezapVariable()
        {
            LoadVariables();
        }

        public static FezapVariable Get(string name)
        {
