...
{
    internal class AnnoyanceRemoval : IFezapFeature
    {
        ...
        private FezapVariable SkipDotLoadingVariable;
        ...
        public void Initialize()
        {
            ...
            SkipDotLoadingVariable = new FezapVariable("skip_dot_loading", "If set, skip the long Dot loading screens", "true")
            {
                SaveOnChange = true,
                Min = 0,
                Max = 1
